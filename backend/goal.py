...
- Generate only simple, single-line goals using only 2 columns at a time, phrased as direct instructions or questions. Example: "Which department has the highest average rating?", "List top 10 students by rating", "How does contest participation vary by year?", etc.
